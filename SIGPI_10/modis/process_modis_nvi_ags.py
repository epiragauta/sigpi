...
in_raster_copy = "PROCESS_MODIS_NVI_AGS_BASE_TMP_DIR\" + "tmpMosaic.500m_16_days_NDVI_2.tif"
...
# _prj_magna_adjust
out_raster4= base_tmp_dir + "tmpMosaic.500m_16_days_NDVI_GEO.tif"
arcpy.gp.RasterCalculator_sa("Float('" + out_raster + "') / " + ndvi_factor,out_raster4)
